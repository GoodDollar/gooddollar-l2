      ...
      {perpsPositions.length === 0 ? (
        ...
        <div className="space-y-2">
          {perpsPositions.slice(0, 3).map(p => (
            <Link key={`${p.symbol}-${p.side}`} href="/perps" className="flex items-center justify-between py-2 px-3 rounded-xl hover:bg-dark-50/30 transition-colors">
              ...
              <div className="text-right">
                <div className="text-sm text-white">${p.positionValue.toFixed(2)}</div>
