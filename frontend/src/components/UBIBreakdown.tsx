  ...
  return (
    <div className="mx-4 mt-3 p-3 rounded-xl bg-goodgreen/5 border border-goodgreen/20">
      <div className="flex items-center gap-2">
        <div className="w-6 h-6 rounded-full bg-goodgreen/10 flex items-center justify-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-goodgreen mt-0.5">
            33% of the swap fee goes directly to the GoodDollar UBI pool
          </p>
        </div>
      </div>
    </div>
