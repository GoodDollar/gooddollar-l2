const steps = [
  ...
  {
    // Task 0040 — was "640K+ People" but that literal collided with the
    // fabricated landing-page counters. The step is a descriptor of the
    // *recipients* in the funding flow, not a live counter, so use a
    // neutral label.
    label: "Recipients",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
