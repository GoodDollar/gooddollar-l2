...
export default function GovernanceAnalyticsClient() {
    ...
    <div className="w-full max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-gray-900/50 rounded-xl border border-gray-800 p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 text-sm">
          ...
          <div className="min-w-0"><span className="text-gray-500">Penalty → UBI:</span> <span className="text-white">33%</span></div>
