...
- Name: navigation.spec.ts >> Header navigation — mobile >> mobile menu shows Coming Soon for Pool and Bridge
- Location: e2e/navigation.spec.ts:105:7
...
Locator: getByTestId('mobile-nav').getByText('Coming Soon').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('mobile-nav').getByText('Coming Soon').first()
      ...
      - generic [ref=e61]:
        ...
        - generic [ref=e137]:
          ...
          - generic [ref=e139]:
            ...
            - generic [ref=e147]:
              ...
              - paragraph [ref=e153]: 33% of every trading fee goes directly to the GoodDollar UBI pool — automatically.
            - generic [ref=e154]:
              - generic [ref=e155]: "3"
              - img [ref=e157]
        ...
        - generic [ref=e196]:
          ...
          - generic [ref=e199]:
            ...
            - link "GoodStable Mint gUSD stablecoin by locking collateral. 33% of fees fund UBI. Open Vault →" [ref=e240] [cursor=pointer]:
              - /url: /stable
              - generic [ref=e241]:
                - img [ref=e243]
                - generic [ref=e245]: GoodStable
              - paragraph [ref=e246]: Mint gUSD stablecoin by locking collateral. 33% of fees fund UBI.
