module.exports = [
"[project]/node_modules/requestidlecallback/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(factory) {
    ...
    var root = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "object") != undefined ? /*TURBOPACK member replacement*/ __turbopack_context__.g : this || {};
...
"[project]/node_modules/@axe-core/react/dist/index.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// index.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axe-core/axe.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$requestidlecallback$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/requestidlecallback/index.js [app-ssr] (ecmascript)");
;
;
// after.ts
...
// index.ts
var requestIdleCallback = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$requestidlecallback$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["request"];
var cancelIdleCallback = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$requestidlecallback$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cancel"];
var React;
var ReactDOM;
var logger;
var lightTheme = {
...
function logFailureMessage(node, key) {
    const message = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]._audit.data.failureSummaries[key].failureMessage(node[key].map((check)=>check.message || ""));
...
function checkAndReport(node, timeout2) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        idleId = requestIdleCallback(()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].configure({
                allowedOrigins: [
                    "<unsafe_all_origins>"
                ]
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].run(n, {
                reporter: "v2"
...
function reactAxe(_React, _ReactDOM, _timeout, _conf = {}, _context, _logger) {
    ...
    if (runOnly) {
        conf["rules"] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getRules(runOnly).map((rule)=>({
                ...rule,
                id: rule.ruleId,
                enabled: true
            }));
    ...
    if (Object.keys(conf).length > 0) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].configure(conf);
    }
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axe$2d$core$2f$axe$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].configure({
        allowedOrigins: [
            "<unsafe_all_origins>"
...
//# sourceMappingURL=node_modules_10eb_3p._.js.map