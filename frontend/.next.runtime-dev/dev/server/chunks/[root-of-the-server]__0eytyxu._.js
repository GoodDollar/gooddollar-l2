...
"[project]/frontend/src/app/api/hedge-proof/latest/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "GET",
    ()=>GET,
    "PROOF_UNREADABLE_MESSAGE",
    ()=>PROOF_UNREADABLE_MESSAGE,
    "RELATIVE_SOURCE_LOCATOR",
    ()=>RELATIVE_SOURCE_LOCATOR,
    "runtime",
    ()=>runtime
]);
...
function resolveProofDir() {
    if (process.env.HEDGE_PROOF_DIR) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].resolve(process.env.HEDGE_PROOF_DIR);
    }
    return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].resolve(process.cwd(), '..', 'qa-proof', 'hedges');
}
const RELATIVE_SOURCE_LOCATOR = 'qa-proof/hedges/latest.json';
const PROOF_UNREADABLE_MESSAGE = 'Hedge proof file is present but unreadable.';
async function handleGet(_req) {
    const proofPath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(resolveProofDir(), 'latest.json');
    try {
        const raw = await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].readFile(proofPath, 'utf8');
        ...
        const errno = err;
        console.error('[hedge-proof] read failed', {
            name: errno.name,
            code: errno.code
        }, err);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0eytyxu._.js.map