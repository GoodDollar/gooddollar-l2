...
"[project]/frontend/src/app/api/prices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handleGet(req) {
    ...
    if (ids.length === 0) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])(400, 'no_supported_symbols', `No supported symbols in request. Requested: ${requested.join(', ')}`, {
    ...
    const envelope = (prices, extraHeaders)=>{
        const body = {
            ...prices,
            prices,
            requested,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13vw8fs._.js.map