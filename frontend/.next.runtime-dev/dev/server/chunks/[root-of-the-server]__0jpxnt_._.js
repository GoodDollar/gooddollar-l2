...
async function handleGet(_req) {
    ...
    if (!safePath) {
        return markdown('# Forbidden\n\nThe proof pointer resolved to a path outside the allowed proof directory.\n', 403);
    }
    try {
        const body = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["readFile"])(safePath, 'utf8');
        return markdown(body, 200);
    } catch  {
        return markdown(`# Hedge proof unavailable\n\nCould not read the proof file at \`${__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["basename"](safePath)}\`.\n`, 502);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jpxnt_._.js.map