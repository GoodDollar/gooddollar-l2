...
"[project]/frontend/src/lib/hedge-proof-validate-receipt-id.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function validateReceiptId(raw) {
    const input = raw ?? '';
    ...
    if (CONTROL_OR_FORMAT.test(input)) {
        return {
            ok: false,
            reason: 'Receipt id contains invalid characters'
        };
    }
...
"[project]/frontend/src/app/api/hedge/proof/[receiptId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$hedge$2d$proof$2d$validate$2d$receipt$2d$id$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/hedge-proof-validate-receipt-id.ts [app-route] (ecmascript)");
...
async function probeEngine(urls) {
    const errors = [];
    let lastError = null;
    let sawNotFound = false;
    for (const url of urls){
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$hedge$2d$proof$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["timedFetch"])(url);
            if (res.ok) {
                return {
                    ok: true,
                    response: res,
...
async function handleGet(_req, ctx) {
    // Next 16's `params` arrives as a Promise; older versions ship a
    // plain object. Detect both shapes so the route stays portable.
    const params = ctx ? ctx.params : undefined;
    const resolved = params ? await Promise.resolve(params) : {
        receiptId: ''
    };
    const decoded = (()=>{
        try {
    ...
    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$hedge$2d$proof$2d$validate$2d$receipt$2d$id$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateReceiptId"])(decoded);
    if (!validation.ok) {
        return json({
            status: 'invalid_id',
    ...
    const outcome = await probeEngine((0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$hedge$2d$proof$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["proofUrlsForReceipt"])(id));
    if (!outcome.ok) {
    ...
    let pointer;
    try {
        pointer = await outcome.response.json();
    } catch  {
        return json({
            status: 'unreadable',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jgk~rr._.js.map