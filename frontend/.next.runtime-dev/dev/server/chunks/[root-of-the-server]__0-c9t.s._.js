...
"[project]/frontend/src/app/api/status/quotes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeQuoteStatus(data, now = Date.now()) {
    ...
    const normalizedQuotes = quotes.filter((q)=>typeof q.symbol === 'string' && q.symbol.length > 0).map((q)=>{
        const productSync = {
            amm: {
                lastSyncedBlock: oracleBlock
            },
            perps: {
                lastSyncedBlock: oracleBlock
            },
        ...
        for (const product of Object.keys(productSync)){
...
async function handleGet(_req) {
    try {
        ...
        const res = await fetch(QUOTE_STATUS_URL, {
        ...
        if (!res.ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Quote status endpoint returned an error',
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(normalizeQuoteStatus(data));
    } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-c9t.s._.js.map