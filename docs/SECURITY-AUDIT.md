...
- [`docs/security/TESTING-PLAN.md`](security/TESTING-PLAN.md) — consolidated Slither/Foundry/fuzz/invariant testing plan, per-contract coverage inventory, and per-area threat/invariant notes.
- [`docs/security/CONTRACT-PROVENANCE.md`](security/CONTRACT-PROVENANCE.md) — contract origins (OZ fork vs custom), SLOC, reentrancy guard status, and audit priorities.
- [`docs/SLITHER-REPORT.md`](SLITHER-REPORT.md) — latest Slither baseline summary and findings counts.
