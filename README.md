...
> *Updated: 2026-05-15 — task 0034 (CRITICAL `/swap` prerender-redirect fix — moved redirect from server-component `page.tsx` to `next.config.js` `async redirects()`; live host now returns proper 307 + `Location: /` + empty body; Foundry suite 1020 / 1020 green)*
