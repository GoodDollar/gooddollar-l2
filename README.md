...
- **628 commits** · **62 smart contracts** · **12,800 lines of Solidity** · **1020 tests passing**
...
|-----------|---------|--------|---------|
| **GoodDollar L2** (root) | `0.2.0` | 🟢 Active | 628 commits, 62 contracts, 12.8K lines Solidity |
...
> *Updated: 2026-05-15 — task 0035 (CRITICAL `/explore/G$` URL-decode fix — `decodeSymbolParam()` guards `decodeURIComponent` in render path so percent-encoded route segments now match the canonical `G$` token symbol; flagship token detail page renders end-to-end; `react-doctor` 97/100)*
