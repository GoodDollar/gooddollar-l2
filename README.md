...
- **632 commits** · **62 smart contracts** · **12,800 lines of Solidity** · **1020 tests passing**
...
|-----------|---------|--------|---------|
| **GoodDollar L2** (root) | `0.2.0` | 🟢 Active | 632 commits, 62 contracts, 12.8K lines Solidity |
...
> *Updated: 2026-05-15 — task 0037 (Stable — block over-max amounts in VaultPanel before sending tx across Deposit / Withdraw / Mint / Repay; red border + inline error + disabled submit + `aria-invalid` / `aria-describedby`; parity with `/lend` and `/perps`; `react-doctor` 96/100)*
