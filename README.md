...
> *Updated: 2026-05-15 — task 0036 (Explore — fix duplicate "No more X today" empty-state rows; Top Gainers / Trending now render a single centered empty-state message on zero data and an `aria-hidden` non-breaking-space placeholder for partial lists; `react-doctor` 94/100)*
