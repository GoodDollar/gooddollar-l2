...
> *Updated: 2026-05-16 — task 0038 (CRITICAL — Header `Connect Wallet` clipped off-screen at 1024–1535px; moved desktop nav crossover from `sm` → `2xl`, container `max-w-5xl → max-w-7xl`, dropped `/tests` from inline nav, tightened gap; 4 new TDD regression tests + e2e viewport bump; verified live at 1024/1280/1536 — wallet button no longer clipped, no horizontal overflow at any width)*
