  ...
  apps: [
    ...
    app({
      ...
      env: {
        ...
        ORACLE_SIGNER_ALLOWED_CHAIN_IDS: pick('ORACLE_SIGNER_ALLOWED_CHAIN_IDS', '42069'),
        ORACLE_UPDATE_INTERVAL: pick('ORACLE_UPDATE_INTERVAL', '5000'),
        ORACLE_MIN_DEVIATION: pick('ORACLE_MIN_DEVIATION', '10'),
        ORACLE_SYMBOLS: pick('ORACLE_SYMBOLS', 'AAPL,TSLA,NVDA,MSFT,META,AMZN,GOOGL,SPY,QQQ,NFLX'),
        SWAP_PRICE_ORACLE_ADDRESS: pickRuntimeAny(['SWAP_PRICE_ORACLE_ADDRESS', 'SWAP_ORACLE_ADDRESS', 'SWAP_ORACLE'], ''),
        CRYPTO_SYMBOL_MAP: pick('CRYPTO_SYMBOL_MAP', ''),
        ORACLE_CRYPTO_SYMBOLS: pick('ORACLE_CRYPTO_SYMBOLS', ''),
        ORACLE_CRYPTO_MIN_DEVIATION: pick('ORACLE_CRYPTO_MIN_DEVIATION', pick('ORACLE_MIN_DEVIATION', '10')),
        ORACLE_CRYPTO_UPDATE_INTERVAL: pick('ORACLE_CRYPTO_UPDATE_INTERVAL', pick('ORACLE_UPDATE_INTERVAL', '5000')),
      },
    }),
