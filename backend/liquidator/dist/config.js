...
exports.CONFIG = {
    ...
    // ─── GoodLend addresses ──────────────────────────────────────────────────
    goodLendPool: process.env.GOODLEND_POOL ?? '0x322813fd9a801c5507c9de605d63cea4f2ce6c44',
    goodLendOracle: process.env.GOODLEND_ORACLE ?? '0x9a9f2ccfde556a7e9ff0848998aa4a0cfd8863ae',
    ...
    vaultManager: process.env.VAULT_MANAGER ?? '0x5eb3bc0a489c5a8288765d2336659ebca68fcd00',
    collateralRegistry: process.env.COLLATERAL_REGISTRY ?? '0x9d4454b023096f34b160d6b654540c56a1f81688',
