...
exports.PROTOCOLS = exports.ADDRESSES = exports.INITIAL_LOOKBACK = exports.POLL_INTERVAL_MS = exports.REPORTER_KEY = exports.CHAIN_ID = exports.RPC_URL = void 0;
exports.RPC_URL = process.env.RPC_URL || 'http://localhost:8545';
exports.CHAIN_ID = 42069;
// Deployer/reporter private key (has admin on AgentRegistry)
exports.REPORTER_KEY = process.env.REPORTER_KEY ||
    '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80';
// Poll interval in ms (how often to scan for new events)
exports.POLL_INTERVAL_MS = Number(process.env.POLL_INTERVAL_MS) || 5_000;
// How many blocks to look back on first run
exports.INITIAL_LOOKBACK = Number(process.env.INITIAL_LOOKBACK) || 1000;
// ─── Contract Addresses ───────────────────────────────────────────────────────
exports.ADDRESSES = {
...
exports.PROTOCOLS = [
    {
        name: 'swap',
        address: exports.ADDRESSES.GoodSwapRouter,
        events: [
            {
    ...
    {
        name: 'perps',
        address: exports.ADDRESSES.PerpEngine,
        events: [
            {
    ...
    {
        name: 'lend',
        address: exports.ADDRESSES.GoodLendPool,
        events: [
            {
    ...
    {
        name: 'predict',
        address: exports.ADDRESSES.MarketFactory,
        events: [
            {
    ...
    {
        name: 'stocks',
        address: exports.ADDRESSES.CollateralVault,
        events: [
            {
