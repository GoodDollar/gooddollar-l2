...
exports.HarvestKeeper = exports.DEFAULT_CONFIG = exports.ERC20ABI = exports.StrategyABI = exports.GoodVaultABI = exports.VaultFactoryABI = void 0;
...
exports.DEFAULT_CONFIG = {
    ...
    dryRun: false,
    maxGasPrice: ethers_1.ethers.parseUnits('50', 'gwei'),
};
// ─── Core Engine ────────────────────────────────────────────────────────────
class HarvestKeeper {
    constructor(config) {
        ...
        this.factory = new ethers_1.ethers.Contract(config.factoryAddress, exports.VaultFactoryABI, this.provider);
    }
    ...
    async getVaultInfo(address) {
        const vault = new ethers_1.ethers.Contract(address, exports.GoodVaultABI, this.provider);
        const [name, symbol, asset, totalAssets, totalDebt, totalSupply, lastReport, strategy, paused, totalGain, totalUBIFunded,] = await Promise.all([
            vault.name(),
            vault.symbol(),
            vault.asset(),
            vault.totalAssets(),
        ...
        // Get asset details
        const assetContract = new ethers_1.ethers.Contract(asset, exports.ERC20ABI, this.provider);
        ...
        try {
            const strat = new ethers_1.ethers.Contract(strategy, exports.StrategyABI, this.provider);
    ...
    async harvestVault(vaultAddress) {
        const vault = new ethers_1.ethers.Contract(vaultAddress, exports.GoodVaultABI, this.signer);
        ...
        try {
            ...
            if (gasPrice > this.config.maxGasPrice) {
                console.warn(`[harvest-keeper] Gas too high: ${ethers_1.ethers.formatUnits(gasPrice, 'gwei')} gwei`);
                return null;
            }
            ...
            const profitStr = ethers_1.ethers.formatUnits(profit, info.assetDecimals);
            const lossStr = ethers_1.ethers.formatUnits(loss, info.assetDecimals);
    ...
    async runCycle() {
        ...
        console.log(`[harvest-keeper] Cycle complete: ${results.length} harvests, ` +
...
exports.HarvestKeeper = HarvestKeeper;
